...
public class SpawnRoutePOI : MonoBehaviour
{
    ...
    public List<GameObject> RouteClicked(List<Poi> routesPoi)
    {
        _spawnedObjects = new List<GameObject>();

        int POIsCount = routesPoi.Count;
        print("POIsCount: " + POIsCount);
    ...
    //public List<GameObject> RouteClicked(string routeCode)
    //{
    //    Route route = RouteDataHolder.GetRoute(routeCode);
    //    _spawnedObjects = new List<GameObject>();
